...
### 4. Steps Followed
*  Cleaned the data using Excel and Power Query. I replaced missing values with ‘Unknown’. I changed Date column into Date format. Then I changed the runtime column from text to numbers. 
